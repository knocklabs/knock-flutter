...
mixin _$FeedEvent {
 ...
 FeedEventType get eventType; List<FeedItem> get items; FeedMetadata get metadata;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( FeedEventType eventType,  List<FeedItem> items,  FeedMetadata metadata)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FeedEvent() when $default != null:
return $default(_that.eventType,_that.items,_that.metadata);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( FeedEventType eventType,  List<FeedItem> items,  FeedMetadata metadata)  $default,) {final _that = this;
switch (_that) {
case _FeedEvent():
return $default(_that.eventType,_that.items,_that.metadata);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( FeedEventType eventType,  List<FeedItem> items,  FeedMetadata metadata)?  $default,) {final _that = this;
switch (_that) {
case _FeedEvent() when $default != null:
return $default(_that.eventType,_that.items,_that.metadata);case _:
  return null;
...
/// Create a copy of FeedEvent
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? eventType = null,Object? items = null,Object? metadata = null,}) {
  return _then(_FeedEvent(
eventType: null == eventType ? _self.eventType : eventType // ignore: cast_nullable_to_non_nullable
as FeedEventType,items: null == items ? _self._items : items // ignore: cast_nullable_to_non_nullable
as List<FeedItem>,metadata: null == metadata ? _self.metadata : metadata // ignore: cast_nullable_to_non_nullable
as FeedMetadata,
  ));
}
