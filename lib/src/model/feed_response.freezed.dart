...
mixin _$OnNewMessageResponse {
  ...
  $OnNewMessageResponseCopyWith<OnNewMessageResponse> get copyWith =>
      _$OnNewMessageResponseCopyWithImpl<OnNewMessageResponse>(
          this as OnNewMessageResponse, _$identity);
...
abstract mixin class $OnNewMessageResponseCopyWith<$Res> {
  factory $OnNewMessageResponseCopyWith(OnNewMessageResponse value,
          $Res Function(OnNewMessageResponse) _then) =
      _$OnNewMessageResponseCopyWithImpl;
  @useResult
...
extension OnNewMessageResponsePatterns on OnNewMessageResponse {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_OnNewMessageResponse value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(FeedMetadata metadata)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _OnNewMessageResponse implements OnNewMessageResponse {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$OnNewMessageResponseCopyWith<_OnNewMessageResponse> get copyWith =>
      __$OnNewMessageResponseCopyWithImpl<_OnNewMessageResponse>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$OnNewMessageResponseToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _OnNewMessageResponse &&
            (identical(other.metadata, metadata) ||
                other.metadata == metadata));
  }
...
/// @nodoc
abstract mixin class _$OnNewMessageResponseCopyWith<$Res>
    implements $OnNewMessageResponseCopyWith<$Res> {
  factory _$OnNewMessageResponseCopyWith(_OnNewMessageResponse value,
          $Res Function(_OnNewMessageResponse) _then) =
      __$OnNewMessageResponseCopyWithImpl;
  @override
  @useResult
  $Res call({FeedMetadata metadata});
